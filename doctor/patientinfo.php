...
<head>
    ...
    <title>Patient Information | Predictor</title>
...
$sql = "SELECT * FROM diagnosis WHERE diagnosis.user_id = $patient_id  ORDER by diagnosis.id DESC LIMIT 20";
if ($result = mysqli_query($db, $sql)) {
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_array($result)) {
    ...
    <div class="container">
        <div class="card mb-4">
            <div class="card-body text-center">
                ...
                <div class="card-text"><?php echo $patient_name; ?>'s predicted risk of getting diabetes, compared to previous patients.</div>
            </div>
        </div>
    </div>
